          ...
          <div className="achievements-summary">
            ...
            <div className="achievements-summary-meta">
              ...
              {data.steamAvailable && (
                <GameButton
                  variant="outline"
                  icon="/assets/icons/Socials/I_SteamIcon.png"
                  className="achievements-steam-button"
                  onClick={() => void bridgeCall('game.open_steam_achievements').catch(acknowledgeBridgeFailure)}
                >
                  {t('Achievements.ViewOnSteam')}
                </GameButton>
              )}
            </div>
          </div>

...
function mapForce(data: MilitaryOverviewForce): MilitaryForce {
  return {
    ...
    isNavy: data.isNavy,
    isPersonalGuard: data.isPersonalGuard,
...
function mapMilitary(data: GetMilitaryDataResponse): Army | null {
  ...
  return {
    ...
    garrisonedAtId: data.garrisonedAtId || undefined,
    currentOrderTargetId: data.currentOrderTargetId || undefined,
    currentOrderTargetName: data.currentOrderTargetName || undefined,
    currentOrderTargetType: data.currentOrderTargetType || undefined,

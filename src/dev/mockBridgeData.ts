...
function settlementBase(id: string): BridgeResponse<'game.get_settlement_data'> {
  ...
  return {
    ...
    growthBreakdown: [{ name: 'Food supply', value: 4 }, { name: 'Urban crowding', value: -2 }],
      ...
      queue: [
        {
          ...
          toLevel: 1,
          goldCost: 720,
          resourceCost: [{ name: 'Stone', amount: 80 }, { name: 'Wood', amount: 30 }],
          durationDays: 120,
          remainingDays: 63,
          state: 'building',
        ...
        },
        {
          ...
          toLevel: 4,
          goldCost: 540,
          resourceCost: [{ name: 'Stone', amount: 45 }, { name: 'Tools', amount: 15 }],
          durationDays: 90,
          remainingDays: 90,
          state: 'queued',
          statusLabel: 'Queued',
          statusReason: 'Waiting for the aqueduct crew.',
          missingResources: [{ name: 'Tools', amount: 8 }, { name: 'Stone', amount: 12 }],
        },
      ],
...
function militaryData(id: string): BridgeResponse<'game.get_military_data'> {
  ...
  return {
    ...
    garrisonedAt: profile.garrisonedAt,
...
function militaryOverview(): BridgeResponse<'game.get_military_overview'> {
  return {
    forces: [
      { id: MOCK_IDS.military, debugShortId: mockDebugShortId(MOCK_IDS.military), name: 'I Field Army', parentId: '', rank: 'Dux', commanderName: 'Valen Arcastus', commanderId: MOCK_IDS.character, commanderDebugShortId: mockDebugShortId(MOCK_IDS.character), strength: 6800, maxStrength: 7600, morale: 84, supplyDays: 54, isNavy: false, doctrine: 'concentrate', template: 'Balanced Field Army', location: 'Aurelion', currentOrder: 'Holding Aurelion', delegated: false, autoSquashRebels: true, isPlayerControlled: true },
      { id: 'mock-military-detachment', debugShortId: mockDebugShortId('mock-military-detachment'), name: 'Aurelion Detachment', parentId: MOCK_IDS.military, rank: 'Legatus', commanderName: 'Cassian Arcastus', commanderId: MOCK_IDS.heir, commanderDebugShortId: mockDebugShortId(MOCK_IDS.heir), strength: 1600, maxStrength: 1800, morale: 71, supplyDays: 43, isNavy: false, doctrine: 'garrison', template: 'Balanced Field Army', location: 'Aurelion', currentOrder: 'Garrisoning Aurelion', delegated: true, autoSquashRebels: false, isPlayerControlled: true },
      { id: 'mock-military-scouts', debugShortId: mockDebugShortId('mock-military-scouts'), name: 'Western Scouts', parentId: MOCK_IDS.military, rank: 'Legatus', commanderName: 'Marcia Vennor', commanderId: MOCK_IDS.governor, commanderDebugShortId: mockDebugShortId(MOCK_IDS.governor), strength: 420, maxStrength: 520, morale: 68, supplyDays: 32, isNavy: false, doctrine: 'screen', template: 'Light Border Screen', location: 'Berginian March', currentOrder: 'Screening the western road', delegated: true, autoSquashRebels: false, isPlayerControlled: true },
      { id: MOCK_IDS.navy, debugShortId: mockDebugShortId(MOCK_IDS.navy), name: 'Classis Meridian', parentId: '', rank: 'Praefectus', commanderName: 'Marcia Vennor', commanderId: MOCK_IDS.governor, commanderDebugShortId: mockDebugShortId(MOCK_IDS.governor), strength: 1800, maxStrength: 2200, morale: 76, supplyDays: 88, isNavy: true, doctrine: 'screen', template: 'Coastal Patrol', location: 'Namaris', currentOrder: 'Patrolling Namaris', delegated: false, autoSquashRebels: false, isPlayerControlled: true },
      { id: 'mock-navy-riverwatch', debugShortId: mockDebugShortId('mock-navy-riverwatch'), name: 'Riverwatch Flotilla', parentId: MOCK_IDS.navy, rank: 'Legatus', commanderName: 'Severus Laco', commanderId: 'mock-person-tribune', commanderDebugShortId: mockDebugShortId('mock-person-tribune'), strength: 900, maxStrength: 1100, morale: 69, supplyDays: 61, isNavy: true, doctrine: 'screen', template: 'River Patrol', location: 'Tavarii Ford', currentOrder: 'Watching the ford crossings', delegated: true, autoSquashRebels: false, isPlayerControlled: true },
    ],
    foederati: [
...
function settingsResponse(): BridgeResponse<'game.get_settings'> {
  return {
    ...
    controls: [
      { index: 0, isAxis: false, scale: 0, actionName: 'Pause', label: 'Pause', description: 'Game Speed', groupName: '', groupLabel: '', groupItemLabel: '', keyName: 'SpaceBar', keyDisplay: 'Space', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 1, isAxis: false, scale: 0, actionName: 'Screen_Economy', label: 'Economy', description: 'Screens', groupName: '', groupLabel: '', groupItemLabel: '', keyName: 'F2', keyDisplay: 'F2', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 2, isAxis: false, scale: 0, actionName: 'SelectAllMilitaries', label: 'Select All Military', description: 'Selection', groupName: '', groupLabel: '', groupItemLabel: '', keyName: 'A', keyDisplay: 'A', shift: false, ctrl: true, alt: false, cmd: false },
      { index: 3, isAxis: false, scale: 0, actionName: 'MapMode_AdminRegion', label: 'Map: Administrative Regions', description: 'Map Modes', groupName: '', groupLabel: '', groupItemLabel: '', keyName: 'One', keyDisplay: '1', shift: false, ctrl: true, alt: false, cmd: false },
      { index: 4, isAxis: false, scale: 0, actionName: 'MapMode_AdminLand', label: 'Map: Administrative Lands', description: 'Map Modes', groupName: '', groupLabel: '', groupItemLabel: '', keyName: 'Two', keyDisplay: '2', shift: false, ctrl: true, alt: false, cmd: false },
      { index: 5, isAxis: false, scale: 0, actionName: 'MapMode_AdminDomain', label: 'Map: Administrative Domains', description: 'Map Modes', groupName: '', groupLabel: '', groupItemLabel: '', keyName: 'Three', keyDisplay: '3', shift: false, ctrl: true, alt: false, cmd: false },
      { index: 0, isAxis: true, scale: 1, actionName: 'MoveForward', label: 'Move Forward', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Forward', keyName: 'W', keyDisplay: 'W', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 1, isAxis: true, scale: -1, actionName: 'MoveForward', label: 'Move Backward', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Back', keyName: 'S', keyDisplay: 'S', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 2, isAxis: true, scale: 1, actionName: 'MoveForward', label: 'Move Forward', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Forward', keyName: 'Up', keyDisplay: 'Up', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 3, isAxis: true, scale: -1, actionName: 'MoveForward', label: 'Move Backward', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Back', keyName: 'Down', keyDisplay: 'Down', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 4, isAxis: true, scale: -1, actionName: 'MoveRight', label: 'Move Left', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Left', keyName: 'A', keyDisplay: 'A', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 5, isAxis: true, scale: 1, actionName: 'MoveRight', label: 'Move Right', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Right', keyName: 'D', keyDisplay: 'D', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 6, isAxis: true, scale: -1, actionName: 'MoveRight', label: 'Move Left', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Left', keyName: 'Left', keyDisplay: 'Left', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 7, isAxis: true, scale: 1, actionName: 'MoveRight', label: 'Move Right', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Right', keyName: 'Right', keyDisplay: 'Right', shift: false, ctrl: false, alt: false, cmd: false },
    ],
    availableLlmModels: [
    ...
    switch (action as BridgeActionName) {
          ...
          units: [
            {
              ...
              upkeep: 18,
              foodConsumption: 12,
              resourceCost: [{ name: 'Weapons', amount: 24 }, { name: 'Armour', amount: 8 }],
              monthlyConsumption: [{ name: 'Grain', amount: 2 }],
              speed: 4,
              pierceDamage: 8,
              crushDamage: 5,
              slashDamage: 9,
            ...
            },
            {
              ...
              upkeep: 42,
              foodConsumption: 20,
              resourceCost: [{ name: 'Horses', amount: 18 }, { name: 'Armour', amount: 16 }],
              monthlyConsumption: [{ name: 'Grain', amount: 4 }],
              speed: 7,
              pierceDamage: 12,
              crushDamage: 10,
              slashDamage: 8,
            ...
            },
            {
              ...
              upkeep: 34,
              foodConsumption: 16,
              resourceCost: [{ name: 'Weapons', amount: 28 }, { name: 'Leather', amount: 12 }],
              monthlyConsumption: [{ name: 'Grain', amount: 3 }],
              speed: 5,
              pierceDamage: 8,
              crushDamage: 7,
              slashDamage: 13,
      ...
      case 'game.get_income_breakdown':
        return {
          ...economyOverview(),
          settlements: [
            { name: 'Rephsia', amount: 6470 },
            { name: 'Vallis Regio', amount: 1000 },
            { name: 'Lacertum', amount: 820 },
      ...
      case 'game.get_world_glances':
        return {
          ...
          snapshotRevision: 0,
          settlements: [
            { id: MOCK_IDS.settlement, debugShortId: mockDebugShortId(MOCK_IDS.settlement), screenX: 760, screenY: 410, scale: 1, opacity: 1, zOrder: 10, detailLevel: 'full', selected: false, targeted: false, name: 'Aurelion', faction: { ...playerFactionReference(), relation: 'own' }, hasOccupier: false, occupier: { ...playerFactionReference(), relation: 'own' }, isCapital: true, isProvincialCapital: true, settlementType: 'metropolis', health: 0.92, besieged: false, siegeProgress: 0, fortification: 78, fortificationProgress: 0.78, starving: false, diseased: false, mode: state.activeMapMode, mapModeId: state.activeMapMode, mapModeLabel: mockMapModeLabel(state.activeMapMode), monthlyIncome: 122, tradeValue: 31.5, corruption: 0.14, population: 384000, unrest: 0.08, loyalty: 76, garrison: 720, resources: [{ icon: '/assets/resources/Food.png', label: 'Food', stock: 1200 }, { icon: '/assets/resources/Stone.png', label: 'Stone', stock: 260 }], culture: { label: 'Rephsian', colour: rephsianCulture.colour }, religion: { label: 'Rephsian Pantheon', colour: rephsianReligion.colour }, governorName: 'Marcia Vennor', governorDebugShortId: mockDebugShortId(MOCK_IDS.governor), complianceTargetLabel: 'Governor:', complianceTargetName: 'Marcia Vennor', complianceTargetIsRuler: false, complianceLuxuryLabel: 'Luxuries:', complianceLuxuryStatus: '', regionName: 'Aurelion Basin', landName: 'Inner Dominion', domainName: 'Heartland', independent: true, overlordName: '', bishopName: 'Bishop Caldus', hasBuilding: true, building: { label: 'Aqueduct', progress: 0.48 }, warWithPlayer: false },
            { id: MOCK_IDS.portSettlement, debugShortId: mockDebugShortId(MOCK_IDS.portSettlement), screenX: 1120, screenY: 620, scale: 0.94, opacity: 1, zOrder: 9, detailLevel: 'name', selected: false, targeted: false, name: 'Namaris', faction: { ...playerFactionReference(), relation: 'own' }, hasOccupier: false, occupier: { ...playerFactionReference(), relation: 'own' }, isCapital: false, isProvincialCapital: false, settlementType: 'port', health: 0.84, besieged: false, siegeProgress: 0, fortification: 36, fortificationProgress: 0.36, starving: true, diseased: false, mode: state.activeMapMode, mapModeId: state.activeMapMode, mapModeLabel: mockMapModeLabel(state.activeMapMode), monthlyIncome: 46, tradeValue: 18.4, corruption: 0.28, population: 142000, unrest: 0.18, loyalty: 58, garrison: 360, resources: [{ icon: '/assets/resources/Food.png', label: 'Food', stock: 430 }, { icon: '/assets/resources/Stone.png', label: 'Stone', stock: 90 }], culture: { label: 'Rephsian', colour: rephsianCulture.colour }, religion: { label: 'Rephsian Pantheon', colour: rephsianReligion.colour }, governorName: '', governorDebugShortId: 0, complianceTargetLabel: 'Governor:', complianceTargetName: '', complianceTargetIsRuler: false, complianceLuxuryLabel: 'Luxuries:', complianceLuxuryStatus: '', regionName: 'Namaris Shore', landName: 'Inner Dominion', domainName: 'Heartland', independent: true, overlordName: '', bishopName: '', hasBuilding: true, building: { label: 'Docks', progress: 0.22 }, warWithPlayer: false },
          ],
          ports: [
      ...
      case 'game.get_battle_data': {
        ...
        return {
          ...
          formations: [
            ...
            battleFormationDetail('a-inf-centre', "Marcus' Loyal Cohort", 'attacker', rebelFaction, 'infantry', 'Infantry', 1320, 1500, 55, 30, false, 'staggered', 'Staggered', 'd-inf-centre', 'Legio Invicta Victrix'),
            battleFormationDetail('a-rng-back', 'Berginian Sagittarii', 'attacker', rebelFaction, 'ranged', 'Ranged', 520, 650, 70, 16, false, 'spread', 'Open Order', 'd-inf-centre', 'Legio Invicta Victrix'),
            battleFormationDetail('a-cav-right', 'Cataphract Wing', 'attacker', rebelFaction, 'cavalry', 'Cavalry', 700, 820, 88, 32, false, 'wedge', 'Wedge', 'd-cav-right', 'Ala Equestris Fideles'),
            ...
            battleFormationDetail('d-inf-centre', 'Legio Invicta Victrix', 'defender', loyalFaction, 'infantry', 'Infantry', 1250, 1320, 55, 70, true, 'staggered', 'Staggered', 'a-inf-centre', "Marcus' Loyal Cohort"),
            ...
            battleFormationDetail('d-cav-right', 'Ala Equestris Fideles', 'defender', loyalFaction, 'cavalry', 'Cavalry', 820, 900, 88, 70, true, 'column', 'Column', 'a-cav-right', 'Cataphract Wing'),
          ],
          obstacles: [
  ...
  return {
    ...
    showBattleAfterActionNotification(emit: MockBridgeEventEmitter, outcome: MockOutcome = 'victory') {
      ...
      const summary = victory
        ? 'Victory at Aurelion against The Vordic Host. Our line held the ridge while the enemy centre broke. Our losses: 812. Enemy losses: 2,430. Spoils: 180 grain, 64 weapons.'
        : 'Defeat at Aurelion against The Vordic Host. Our attack lost momentum below the ridge and the enemy held the field. Our losses: 2,430. Enemy losses: 812.';
      emit('game.notification_shown', {
        ...
        battleAfterActionReport: {
          ...
          location: 'Aurelion',
          playerRole: victory ? 'Defender' : 'Attacker',
          summary,
          ...
          unitDamage: victory ? [
            {
              ...
              iconPath: '/assets/icons/UnitTypes/I_Infantry.png',
            ...
            },
            {
              ...
              iconPath: '/assets/icons/UnitTypes/I_Cavalry.png',
              factionId: playerFaction.id,
              factionName: playerFaction.name,
              factionColour: playerFaction.colour,
              factionSecondaryColour: playerFaction.secondaryColour,

  ...
  return {
    ...
    siege: data.siegeStateKind === 'siege' || data.siegeStateKind === 'blockade' || data.siegeStateKind === 'occupation'
      ? {
          ...
          hostileFactionDiplomaticStatus: data.hostileFactionDiplomaticStatus || undefined,
          hostileFactionSubjectSubtype: data.hostileFactionSubjectSubtype || undefined,
          hostileFactionIsPlayer: data.hostileFactionIsPlayer,
          hostileFactionIsRebel: data.hostileFactionIsRebel,

      ...
      <StyledScrollArea className="settings-body" viewportClassName="settings-body__viewport">
        {settingsTab === 'gameplay' && (
          <div className="settings-panel">
            ...
            <SettingsSlider label={webUIText('Auto.Attr.ComponentsSettingsSettingsPanel.751.34')} desc={webUIText('Auto.ExtraAttr.ComponentsSettingsSettingsPanel.751.12')} value={toPercent(gameplay.uiScale)} min={50} max={150} suffix="%" onChange={v => setGameplay({ uiScale: fromPercent(v) })} />

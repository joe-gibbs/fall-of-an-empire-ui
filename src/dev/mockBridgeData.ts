...
function settingsResponse(): BridgeResponse<'game.get_settings'> {
  return {
    ...
    controls: [
      { index: 0, isAxis: false, scale: 0, actionName: 'Pause', label: 'Pause', description: 'Game Speed', groupName: '', groupLabel: '', groupItemLabel: '', keyName: 'SpaceBar', keyDisplay: 'Space', glyphId: '', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 1, isAxis: false, scale: 0, actionName: 'Pause', label: 'Pause', description: 'Game Speed', groupName: '', groupLabel: '', groupItemLabel: '', keyName: 'Gamepad_Special_Right', keyDisplay: 'Menu Button', glyphId: 'gamepad_menu', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 2, isAxis: false, scale: 0, actionName: 'Select', label: 'Select', description: 'Selection', groupName: '', groupLabel: '', groupItemLabel: '', keyName: 'Gamepad_FaceButton_Bottom', keyDisplay: 'A Button', glyphId: 'gamepad_a', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 3, isAxis: false, scale: 0, actionName: 'Command', label: 'Command', description: 'Selection', groupName: '', groupLabel: '', groupItemLabel: '', keyName: 'Gamepad_FaceButton_Left', keyDisplay: 'X Button', glyphId: 'gamepad_x', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 4, isAxis: false, scale: 0, actionName: 'SelectAllMilitaries', label: 'Select All Military', description: 'Selection', groupName: '', groupLabel: '', groupItemLabel: '', keyName: 'A', keyDisplay: 'A', glyphId: '', shift: false, ctrl: true, alt: false, cmd: false },
      { index: 5, isAxis: false, scale: 0, actionName: 'MapMode_AdminDomain', label: 'Map: Administrative Domains', description: 'Map Modes', groupName: '', groupLabel: '', groupItemLabel: '', keyName: 'Three', keyDisplay: '3', glyphId: '', shift: false, ctrl: true, alt: false, cmd: false },
      { index: 0, isAxis: true, scale: 1, actionName: 'MoveForward', label: 'Move Forward', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Forward', keyName: 'W', keyDisplay: 'W', glyphId: '', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 1, isAxis: true, scale: -1, actionName: 'MoveForward', label: 'Move Backward', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Back', keyName: 'S', keyDisplay: 'S', glyphId: '', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 2, isAxis: true, scale: 1, actionName: 'MoveForward', label: 'Move Forward', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Forward', keyName: 'Gamepad_LeftY', keyDisplay: 'Left Stick', glyphId: 'gamepad_lstick', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 3, isAxis: true, scale: 1, actionName: 'MoveRight', label: 'Move Right', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Right', keyName: 'D', keyDisplay: 'D', glyphId: '', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 4, isAxis: true, scale: -1, actionName: 'MoveRight', label: 'Move Left', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Left', keyName: 'A', keyDisplay: 'A', glyphId: '', shift: false, ctrl: false, alt: false, cmd: false },
      { index: 5, isAxis: true, scale: 1, actionName: 'MoveRight', label: 'Move Right', description: 'Camera', groupName: 'CameraMovement', groupLabel: 'Movement', groupItemLabel: 'Right', keyName: 'Gamepad_LeftX', keyDisplay: 'Left Stick', glyphId: 'gamepad_lstick', shift: false, ctrl: false, alt: false, cmd: false },
    ],
    availableLlmModels: [
